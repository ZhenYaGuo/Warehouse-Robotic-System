...
if("FALSE" STREQUAL "TRUE")
  set(planning_baxter_SOURCE_PREFIX /home/cc/ee106a/fa17/class/ee106a-aax/ros_workspaces/project/src/planning_baxter)
  set(planning_baxter_DEVEL_PREFIX /home/cc/ee106a/fa17/class/ee106a-aax/ros_workspaces/project/devel)
  ...
  set(planning_baxter_INSTALL_PREFIX /home/cc/ee106a/fa17/class/ee106a-aax/ros_workspaces/project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-aax <ee106a-aax@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa17/class/ee106a-aax/ros_workspaces/project/install/${idir}'.  Ask the maintainer 'ee106a-aax <ee106a-aax@todo.todo>' to fix it.")
    endif()
